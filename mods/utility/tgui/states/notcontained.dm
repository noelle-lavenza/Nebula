...
GLOBAL_DATUM_INIT(notcontained_state, /datum/topic_state/notcontained_state, new)

/datum/topic_state/notcontained_state/can_use_topic(atom/src_object, mob/user)
