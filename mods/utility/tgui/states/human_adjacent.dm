...
GLOBAL_DATUM_INIT(human_adjacent_state, /datum/topic_state/human_adjacent_state, new)

/datum/topic_state/human_adjacent_state/can_use_topic(src_object, mob/user)
