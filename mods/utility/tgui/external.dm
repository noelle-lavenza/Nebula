...
/datum/proc/update_static_data_for_all_viewers()
	for (var/datum/tgui/window as anything in SStgui.open_tguis_by_src[ref(src)])
 ...
 */
/datum/proc/ui_act(action, list/params, datum/tgui/ui, datum/topic_state/state)
	SHOULD_CALL_PARENT(TRUE)
	// SEND_SIGNAL(src, COMSIG_UI_ACT, usr, action) // todo: /decl/observ/ui_act?
