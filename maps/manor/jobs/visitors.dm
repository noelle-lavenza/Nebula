/decl/department/manor/visitors
	name                    = "Visitors"
	colour                  = "#685b40"
	display_color           = "#c4bc8c"

/datum/job/manor/visitor
	abstract_type           = /datum/job/manor/visitor
	department_types        = list(/decl/department/manor/visitors)
...
/datum/job/manor/visitor/traveller
	...
	spawn_positions         = -1
	total_positions         = -1
	outfit_type             = /decl/outfit/job/manor/traveller
	skill_points            = 20

/obj/abstract/landmark/start/manor/traveller
	name                    = "Traveller"
...
/datum/job/manor/visitor/traveller/learned
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/manor/traveller/scholar
	skill_points            = 26
	min_skill               = list(
...
/obj/abstract/landmark/start/manor/traveller/learned
...
/datum/job/manor/visitor/beggar_knight
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/manor/beggar_knight
	min_skill               = list(
...
/obj/abstract/landmark/start/manor/beggar_knight
	name                    = "Beggar Knight"
...
/datum/job/manor/visitor/traveller/cleric
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/manor/traveller/cleric
	min_skill               = list(
		SKILL_COMBAT        = SKILL_ADEPT,
		SKILL_WEAPONS       = SKILL_ADEPT,
		SKILL_ATHLETICS     = SKILL_ADEPT,
...
/obj/abstract/landmark/start/manor/cleric
