/decl/department/manor/inn
	name                    = "Inn Workers"
	colour                  = "#404e68"
	display_color           = "#8c96c4"

/datum/job/manor/inn
	abstract_type           = /datum/job/manor/inn
	department_types        = list(/decl/department/manor/inn)
...
/datum/job/manor/inn/innkeeper
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/manor/innkeeper
	head_position           = TRUE
...
/obj/abstract/landmark/start/manor/innkeeper
	name                    = "Innkeeper"
...
/datum/job/manor/inn/inn_worker
	...
	spawn_positions         = 3
	total_positions         = 3
	outfit_type             = /decl/outfit/job/manor/inn_worker
	min_skill               = list(
...
/obj/abstract/landmark/start/manor/inn_worker
	name                    = "Inn Worker"
...
/datum/job/manor/inn/bartender
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/manor/bartender
	min_skill               = list(
...
/obj/abstract/landmark/start/manor/bartender
	name                    = "Bartender"
...
/datum/job/manor/inn/farmer
	...
	spawn_positions         = 3
	total_positions         = 3
	outfit_type             = /decl/outfit/job/manor/farmer
	min_skill               = list(
...
/obj/abstract/landmark/start/manor/farmer
	name                    = "Farmer"
...
/datum/job/manor/inn/storekeeper
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/manor/storekeeper
	min_skill               = list(
...
/obj/abstract/landmark/start/manor/storekeeper
	name                    = "Storekeeper"
