/decl/department/manor/shrine
	name          = "Shrine Attendants"
	colour        = "#404e68"
	display_color = "#8c96c4"

/datum/job/manor/shrine
	abstract_type    = /datum/job/manor/shrine
	department_types = list(/decl/department/manor/shrine)
	skill_points     = 20
	lock_keys     = list(
...
/datum/job/manor/shrine/keeper
	...
	spawn_positions         = 1
	total_positions         = 1
	outfit_type             = /decl/outfit/job/manor/shrine/keeper
	min_skill               = list(
...
/obj/abstract/landmark/start/manor/shrine_keeper
	name                    = "Shrine Keeper"
...
/datum/job/manor/shrine/attendant
	...
	spawn_positions         = 2
	total_positions         = 2
	outfit_type             = /decl/outfit/job/manor/shrine
	min_skill               = list(
		SKILL_STONEMASONRY  = SKILL_BASIC,
		SKILL_CARPENTRY     = SKILL_BASIC,
		SKILL_TEXTILES      = SKILL_BASIC,
...
/obj/abstract/landmark/start/manor/shrine_attendant
